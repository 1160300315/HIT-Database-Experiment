...
int main() {
...

  {
    ...
    for (int i = 0; i < 5; ++i) {
      ...
      if (i == 3) {
        // Keep track of the identifier for the third 
        // page so we can read it later.
  ...
  // This function tests buffer manager, comment this 
  // line if you don't wish to test buffer manager
  testBufMgr();
}
